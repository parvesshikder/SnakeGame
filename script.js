...
function diceRollP1(){
  ...
  if(Number==1){
    ...
    document.getElementById("winer1").innerHTML ='<h4>Bonus 7 Points and Reduct 10 Points</h4>';
    document.getElementById("p1_block_1").src ='';
    document.getElementById("p1_block_2").src ='';
    document.getElementById("p1_block_3").src ='';
    document.getElementById("p1_block_4").src ='';
    ...
    document.getElementById("winer1").innerHTML ='<h4>Bonus 5 Points</h4>';
    document.getElementById("p1_block_1").src ='';
    document.getElementById("p1_block_2").src ='';
    document.getElementById("p1_block_3").src ='';
    document.getElementById("p1_block_4").src ='';
...
function diceRollP2(){
  ...
  if(Number==1){
    ...
    document.getElementById("winer2").innerHTML ='<h4>Bonus 7 Points + Reduct 10 Points</h4>';
    document.getElementById("p2_block_1").src ='';
    document.getElementById("p2_block_2").src ='';
    document.getElementById("p2_block_3").src ='';
    document.getElementById("p2_block_4").src ='';
    ...
    document.getElementById("winer2").innerHTML ='<h4>Bonus 5 Points</h4>';
    document.getElementById("p2_block_1").src ='';
    document.getElementById("p2_block_2").src ='';
    document.getElementById("p2_block_3").src ='';
    document.getElementById("p2_block_4").src ='';
